...
// No longer needed - we use fixed key 'markdown-storage-current' in sessionStorage
// Keeping this for backwards compatibility with any existing code that imports it
export const getStorageKey = () => {
  return 'markdown-storage-current';
};
